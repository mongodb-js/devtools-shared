...
> **Deprecated:** this package is deprecated. Use [`@mongodb-js/shell-bson-parser`](../shell-bson-parser) instead ([COMPASS-11038](https://jira.mongodb.org/browse/COMPASS-11038)).
