...
import resolve, { clearCache } from '../';
...
function withFakeDistro(distro: string) {
  let origDistroId: string | undefined;
...
describe('mongodb-download-url', function () {
  ...
  describe('full.json cache', function () {
    let tmpdir: PathLike, cachePath: PathLike;
    let server: http.Server,
      versionListUrl: string,
      currentFakeVersion: string,
      baseOptions: Options;
