...
export const TO_JS_STRING_TEST_CASES: ToJSStringTestCase[] = [
  {
    title: 'should default to two spaces',
    input: { a: { $exists: true } },
    expected: `{
  a: {
    $exists: true
  ...
  {
    title: 'should allow falsy indentation',
    input: { a: { $exists: true } },
    indent: 0,
    expected: '{a:{$exists:true}}',
  },
  {
    title: 'allows passing custom indent',
    input: { a: { $exists: true } },
    indent: 'pineapple',
    expected: `{
pineapplea: {
...
pineapple}
  ...
  {
    title: 'retains double spaces and new lines in strings',
    input: {
      a: {
  ...
  {
    title:
      'DBRef - preserves the oid type rather than flattening it to a string (numeric oid)',
    input: { a: dbRef('col', 1) },
    indent: 0,
  ...
  {
    title:
      'DBRef - preserves the oid type rather than flattening it to a string (string oid)',
  ...
  {
    title:
      'DBRef - preserves the oid type rather than flattening it to a string (ObjectId oid)',
    input: {
  ...
  {
    title: 'DBRef - includes the db when present',
    input: { a: dbRef('col', 1, 'db') },
    indent: 0,
    expected: '{a:DBRef("col", 1, "db")}',
  },
  {
    title: 'DBRef - includes the fields when present',
    input: { a: dbRef('col', 1, 'db', { b: 1 }) },
    indent: 0,
    expected: '{a:DBRef("col", 1, "db", {b:1})}',
  },
  {
    title: 'DBRef - passes an undefined db when fields are present without one',
    input: { a: dbRef('col', 1, undefined, { b: 1 }) },
    indent: 0,
    expected: '{a:DBRef("col", 1, undefined, {b:1})}',
  },
  {
    title: 'DBRef - omits empty fields',
    input: { a: dbRef('col', 1, undefined, {}) },
    indent: 0,
    expected: '{a:DBRef("col", 1)}',
  },
  {
    title: 'DBRef - preserves BSON types inside fields',
    input: {
      a: dbRef('col', 1, 'db', {
  ...
  {
    title: 'DBRef - escapes quotes in the collection and db',
  ...
  {
    title: 'with indent 0 - should not add extra space when nesting',
    input: { a: { $exists: true } },
    indent: 0,
    expected: '{a:{$exists:true}}',
  },
  {
    title: 'with indent 0 - preserves multi-space and newline values',
    input: {
      a: {
        name: 'multi-line with s  p    a   c\n        \ne  s',
      },
  ...
  {
    title:
      'with indent 0 > when providing a long - correctly converts to NumberLong (small)',
  ...
  {
    title:
      'with indent 0 > when providing a long - correctly converts to NumberLong (large)',
  ...
  {
    title:
      'with indent 0 > when providing a decimal128 - correctly converts to NumberDecimal',
  ...
  {
    title:
      'with indent 0 > when providing an int32 - correctly converts to Int32',
  ...
  {
    title:
      'with indent 0 > when providing a Double - correctly converts to Double',
  ...
  {
    title:
      'with indent 0 > when providing a geo query - does not add any whitespace',
    input: {
      coordinates: {
        $geoWithin: {
  ...
  {
    title: 'with indent 0 > when provided a RegExp - handles /regex/ format',
  ...
  {
    title:
      'with indent 0 > when provided a BSONRegExp - stringifies correctly with options',
  ...
  {
    title:
      'with indent 0 > when provided a BSONRegExp - stringifies correctly with quotes',
  ...
  {
    title:
      'with indent 0 > when provided a BSONRegExp - stringifies correctly without options',
  ...
  {
    title:
      'with indent 0 > when provided a BSONRegExp - stringifies into BSONRegExp when js RegExp cannot handle an option',
    input: {
  ...
  {
    title:
      'with indent 0 > when provided a BSONRegExp - stringifies into BSONRegExp when js RegExp cannot handle the regex',
    input: {
      name: new bson.BSONRegExp(
  ...
  {
    title: 'with indent 0 - should work',
  ...
  {
    title:
      'with indent 0 > when providing a Date - correctly converts to an ISODate',
  ...
  {
    title:
      'with indent 0 > when providing a Date - falls back to an invalid ISODate if the provided Date is invalid',
  ...
  {
    title:
      'with indent 0 > when providing an ISODate - correctly converts to an ISODate',
  ...
  {
    title:
      'with indent 0 > when providing a DBRef with (collection, oid) - correctly converts to a DBRef',
  ...
  {
    title:
      'with indent 0 > when providing a DBRef with (db.collection, oid) - correctly converts to a DBRef',
  ...
  {
    title:
      'with indent 0 > when providing a DBRef with (collection, oid, db) - correctly converts to a DBRef',
  ...
  {
    title:
      'with indent 0 > when provided a RegExp - correctly formats the options',
    input: parse('{name: /foo/i}', filterOptions),
    indent: 0,
    expected: '{name:RegExp("foo", \'i\')}',
  },
  {
    title: 'with indent 0 > when provided a RegExp - escapes quotes',
  ...
  {
    title:
      'with indent 0 > when provided a RegExp - handles $regex object format (keeps format)',
    input: parse(
  ...
  {
    title: 'with indent 0 > when provided a Binary - should support BinData',
    input: parse(
  ...
  {
    title: 'with indent 0 > when provided a Binary - should support UUID',
    input: parse(
  ...
  {
    title:
      'with indent 0 > when provided a Binary - does not convert LegacyJavaUUID to UUID',
    input: parse(
  ...
  {
    title:
      'with indent 0 > when provided a Binary - does not convert LegacyCSharpUUID to UUID',
    input: parse(
  ...
  {
    title:
      'with indent 0 > when provided a Binary - does not convert LegacyPythonUUID to UUID',
    input: parse(
  ...
  },
  {
    ...
    title:
      'with indent 0 > when provided a Binary - should support Binary.createFromHexString',
    input: parse(
  ...
  },
  {
    ...
    title:
      'with indent 0 > when provided a Binary - should support Binary.createFromBase64',
    input: parse(
...
export const TO_JS_STRING_ROUND_TRIP_TEST_CASES: ToJSStringRoundTripTestCase[] =
  [
    {
      title: 'round-trip - escapes quotes, backslashes and newlines in Code',
      input: { a: new bson.Code(`a "b" 'c' \\d\ne`) },
    },
    {
      title: 'round-trip - escapes Code with a scope',
      input: { a: new bson.Code(`');process.exit(1);('`, { b: 1 }) },
    },
    {
      title: 'round-trip - DBRef with numeric oid',
      input: { a: dbRef('col', 1) },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with string oid',
      input: { a: dbRef('col', 'abc') },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with ObjectId oid',
      input: {
        a: dbRef('col', new bson.ObjectId('507f191e810c19729de860ea')),
      },
      indent: 0,
    ...
    {
      title: 'round-trip - DBRef with db',
      input: { a: dbRef('col', 1, 'db') },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with quotes',
      input: { a: dbRef("co'l", 1, 'd"b') },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with double spaces',
      input: { a: dbRef('a  b', 1) },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with newline',
      input: { a: dbRef('a\nb', 1) },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with nested DBRef oid',
      input: { a: dbRef('col', dbRef('inner', 1), 'db') },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with fields',
      input: { a: dbRef('col', 1, 'db', { b: 1 }) },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with fields but no db',
      input: { a: dbRef('col', 1, undefined, { b: 1 }) },
      indent: 0,
    },
    {
      title: 'round-trip - DBRef with BSON values in fields',
      input: {
        a: dbRef('col', 1, 'db', {
          b: new bson.ObjectId('507f191e810c19729de860ea'),
        }),
