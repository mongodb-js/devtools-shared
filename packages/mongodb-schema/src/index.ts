...
import { InternalSchemaBasedAccessor } from './schema-accessor';
...
async function analyzeDocuments(
  ...
  const internalSchema = (
    await getCompletedSchemaAnalyzer(source, options)
  ).getResult();
...
async function getSchemaPaths(source: AnyIterable): Promise<string[][]> {
