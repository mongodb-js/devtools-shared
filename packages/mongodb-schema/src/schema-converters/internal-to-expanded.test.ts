...
import { RELAXED_EJSON_DEFINITIONS } from './internal-to-standard';
import { convertInternalToExpanded } from './internal-to-expanded';

describe('internalSchemaToExpanded', function () {
  describe('Converts: ', function () {
    it('various types', async function () {
            ...
            types: [
              {
                ...
                unique: 1,
                hasDuplicates: false,
                values: ['642d766b7300158b1f22e972'],
                bsonType: 'ObjectId',
              },
            ],
          },
      ...
      const expectedDefinitions: Partial<typeof RELAXED_EJSON_DEFINITIONS> = {
      ...
      assert.deepStrictEqual(expanded, {
        ...
        properties: {
          _id: {
            ...
            'x-sampleValues': ['642d766b7300158b1f22e972'],
          },
          binData: {
            $ref: '#/$defs/Binary',
            'x-bsonType': 'binData',
                  ...
                  },
                  {
                    ...
                    properties: {
                      long: {
                        ...
                        'x-sampleValues': ['science fiction'],
                      },
                      short: {
                        type: 'string',
                        'x-bsonType': 'string',
          ...
          fields: [
            {
              ...
              path: ['mixedComplexType'],
              count: 2,
              type: ['Array', 'Document', 'Undefined'],
              probability: 0.6666666666666666,
              hasDuplicates: false,
              types: [
                {
          ...
          fields: [
            {
              ...
              types: [
                ...
                },
                {
                  ...
                  unique: 1,
                  hasDuplicates: false,
                  values: ['642d766c7300158b1f22e975'],
                  bsonType: 'ObjectId',
                },
              ],
            },
            ...
            mixedType: {
              ...
              anyOf: [
                ...
                },
                {
                  ...
                  'x-sampleValues': ['642d766c7300158b1f22e975'],
                },
              ],
            },
          },
    ...
    it('can be aborted', async function () {
      ...
      const promise = convertInternalToExpanded(internal, {
