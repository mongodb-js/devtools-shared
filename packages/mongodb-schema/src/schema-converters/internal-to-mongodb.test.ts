...
import { convertInternalToMongodb } from './internal-to-mongodb';

describe('internalSchemaToMongoDB', function () {
  describe('Converts: ', function () {
            ...
            types: [
              {
                ...
                fields: [
                  ...
                  },
                  {
                    ...
                    path: ['binaries', 'compressedTimeSeries'],
                    count: 1,
                    type: 'Binary',
                    probability: 0.8,
                    hasDuplicates: false,
            ...
            types: [
              {
                ...
                unique: 1,
                hasDuplicates: false,
                values: ['2023-04-05T13:25:08.445Z'],
                bsonType: 'Date',
              },
            ],
          },
    ...
    it('can be aborted', async function () {
      ...
      const promise = convertInternalToMongodb(internal, {
